...
$domains = [
    ['name' => 'Maël Davidenko', 'domain' => 'davidenko.local'],
    ['name' => 'Gleb Kuznetsov', 'domain' => 'kuznetsov.local'],
    ['name' => 'Kévin Nguyen', 'domain' => 'nguyen.local'],
    ['name' => 'Nicolas Dumont', 'domain' => 'dumont.local'],
    ['name' => 'Savio Joseph', 'domain' => 'joseph.local'],
    ['name' => 'Maxence Fontaine Gros', 'domain' => 'fontainegros.local'],
    ['name' => 'Nolann Prost', 'domain' => 'prost.local'],
    ['name' => 'Axel Rebus', 'domain' => 'rebus.local'],
    ['name' => 'Nesrine Sadir', 'domain' => 'sadir.local'],
    ['name' => 'Sundès Galbi', 'domain' => 'galbi.local'],
    ['name' => 'Alexis Kuntz', 'domain' => 'kuntz.local'],
    ['name' => 'Quentin Jawhar', 'domain' => 'jawhar.local'],
    ['name' => 'Harivony Rakotoson', 'domain' => 'rakotoson.local'],
    ['name' => 'Boris Perier', 'domain' => 'perier.local'],
    ['name' => 'Benjamin Soares Pereira', 'domain' => 'soarespereira.local'],
    ['name' => 'Mathieu Rouzet', 'domain' => 'rouzet.local'],
    ['name' => 'Loris Petitjean', 'domain' => 'petitjean.local'],
    ['name' => 'Jules Bernier', 'domain' => 'bernier.local'],
    ['name' => 'Juliette Bouet', 'domain' => 'bouet.local'],
    ['name' => 'Hamza El Malyani', 'domain' => 'elmalyani.local'],
    ['name' => 'Noah Jallali', 'domain' => 'jallali.local'],
    ['name' => 'Andrea Laurent', 'domain' => 'laurent.local'],
    ['name' => 'Isaac Prot-Jourjon', 'domain' => 'protjourjon.local'],
    ['name' => 'Rayane Zekraoui', 'domain' => 'zekraoui.local'],
    ['name' => 'Younes Meyyah', 'domain' => 'meyyah.local'],
    ['name' => 'Dario Curto', 'domain' => 'curto.local'],
    ['name' => 'Ethan Fontaine', 'domain' => 'fontaine.local'],
    ['name' => 'Idris Eudeline', 'domain' => 'eudeline.local'],
    ['name' => 'Dimitri Junique', 'domain' => 'junique.local'],
    ['name' => 'Daan Begnis', 'domain' => 'begnis.local'],
    ['name' => 'Walid Ouahbi', 'domain' => 'ouahbi.local'],
    ['name' => 'David Briant', 'domain' => 'briant.local'],
];
